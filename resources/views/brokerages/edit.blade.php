    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('brokerages.update', $brokerage) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="brokerageName" value="{{ $brokerage->brokerageName }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="brokerageAddress" value="{{ $brokerage->brokerageAddress }}" required
                            class="mt-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md w-full">
                    </div>
                    <!-- brokeragePhone -->
                    <div class="mb-4">
                        ...
                        <input type="text" name="brokeragePhone" value="{{ $brokerage->brokeragePhone }}" required
                            class="mt-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md w-full">
                    </div>
                    <!-- relatedAgents -->
                    <div class="mb-4">
                        ...
                        <input type="text" name="relatedAgents" value="{{ $brokerage->relatedAgents }}" required
                            class="mt-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md w-full">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="relatedresaleDealsByListingReferralAgentsBrokerage"
                            value="{{ $brokerage->relatedresaleDealsByListingReferralAgentsBrokerage }}" required
                            class="mt-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md w-full">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="relatedresaleDealsByBuyerReferralAgentsBrokerage"
                            value="{{ $brokerage->relatedresaleDealsByBuyerReferralAgentsBrokerage }}" required
                            class="mt-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md w-full">
                    </div>
                    <!-- relatedleaseDeals -->
                    <div class="mb-4">
                        ...
                        <input type="text" name="relatedleaseDeals" value="{{ $brokerage->relatedleaseDeals }}" required
                            class="mt-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md w-full">
                    </div>

                    <button type="submit"
                        class="border bg-blue-500 hover:bg-blue-600 hover:text-white text-black py-2 px-4 rounded-md transition duration-300 ease-in-out">Update</button>
                </form>
            </div>
        </div>
    </div>
